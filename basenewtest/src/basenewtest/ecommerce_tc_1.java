...
public class ecommerce_tc_1 extends base2 {
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		AndroidElement country = driver.findElementByAndroidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView(text(\"Argentina\"));");
		country.click();
